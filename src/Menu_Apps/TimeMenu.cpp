...
void Load_TimeMenu(void){
    ...
    lv_obj_set_style_border_color(time_hour, lv_color_hex(0x323130), 0);
    ...
    lv_obj_add_event_cb(time_hour, TimeMenu_Roller_Event, LV_EVENT_VALUE_CHANGED, NULL);
    ...
    lv_obj_set_style_border_color(time_minute, lv_color_hex(0x323130), 0);
    ...
    lv_obj_add_event_cb(time_minute, TimeMenu_Roller_Event, LV_EVENT_VALUE_CHANGED, NULL);
